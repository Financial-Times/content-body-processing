...
public class SlideshowXMLParser extends BaseXMLParser<SlideshowData> implements XmlParser<SlideshowData> {
    ...
    @Override
    SlideshowData createDataBeanInstance() {
        return new SlideshowData();
    }

    @Override
    void populateBean(SlideshowData dataBean, StartElement nextStartElement, XMLEventReader xmlEventReader) throws UnexpectedElementStructureException {
